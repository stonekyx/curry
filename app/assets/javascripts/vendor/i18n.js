...
I18n.strftime = function(date, format) {
  ...
  options.day_ordinal = options.day_ordinal || [];
  ...
  var ordinal = function(n) {
    if (I18n.currentLocale() == "en-us") {
      // get the ordinal for date day like 1st, 12th, 23rd.
      // the ordinal rule in english is days end with '1', '2', '3' except for '11', '12', '13' are suffixed by 'st', 'nd', 'rd' respectively, and others are suffixed by 'th'.
      var b = n % 10,
          suffix = options.day_ordinal[b > 3 ? 0 : (n % 100 - b != 10) * b];
      return n + suffix;
    }
    return n + "";
  };
